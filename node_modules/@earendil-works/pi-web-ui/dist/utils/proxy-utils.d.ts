 ...
 */
export declare function createStreamFn(getProxyUrl: () => Promise<string | undefined>): (model: Model<any>, context: Context, options?: SimpleStreamOptions) => Promise<import("@earendil-works/pi-ai").AssistantMessageEventStream>;
