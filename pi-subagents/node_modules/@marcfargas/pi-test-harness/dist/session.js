...
export async function createTestSession(options = {}) {
    ...
    const origModelRegistry = session._modelRegistry;
    ...
    const testSession = {
        ...
        async run(...turns) {
            ...
            const interceptedTools = interceptToolExecution(currentTools, effectiveMockTools, events.toolResults, state, propagateErrors, runner);
            session.agent.setTools(interceptedTools);
            // Run each turn
